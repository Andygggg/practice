<template>
  <div class="report1_box">
    <div class="list_box">
      <!-- 功能列表 -->
      <div class="functionBar">
        <MakeButton btn_class="btn_blue" @click="PushToReport1_Create"
          ><i class="bx bxs-calendar-plus"></i>新增鑽探日報表</MakeButton
        >
        <!-- 關鍵字搜尋 -->
      ...
      <div class="table_box">
        <MakeTable
          :table_header="report1Header"
          :table_data="filter_report1List"
          table_scroll="50vh"
...
const keyWord = ref('')
const filter_report1List = computed(() => {
  let filter_date
  if (date_value.value == 0) {
    ...
    filter_date = report1List.value.filter((item) => item.date == formattedDate)
  } else {
    filter_date = report1List.value
  }
...
const PushToReport1_Create = () => {
  router.push({ name: 'Report1_Create' })
}
</script>
